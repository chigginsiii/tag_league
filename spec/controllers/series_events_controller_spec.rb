...
RSpec.describe SeriesEventsController, type: :controller do
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new SeriesEvent' do
        expect do
          post :create, params: { series_event: valid_attributes }, session: valid_session
    ...
    context 'with invalid params' do
      it 'renders a JSON response with errors for the new series_event' do
        post :create, params: { series_event: invalid_attributes }, session: valid_session
